...
const { processGitHubData } = require('../services/githubService');
...
exports.handleGitHubProof = async (req, res) => {
  const { proof, userId, providerId } = req.body;
  const providerName = 'GITHUB_ACCOUNT_VERIFICATION'; // Change this as per your provider name
